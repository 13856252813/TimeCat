package com.cary.activity.timecat.manager.util;
...
public class TimeUtil {
     ...
     * @type 返回结果
     * @param starTime
     * @return //退出APP时，记录当前时间
     *   用当前时间-记录的时间 大于30 就登录
     */
    public boolean compareTwoTime3(String starTime) {
        boolean isDayu = false;
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm");
