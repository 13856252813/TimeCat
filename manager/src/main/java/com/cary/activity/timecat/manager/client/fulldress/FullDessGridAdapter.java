...
public class FullDessGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = FullDessGridAdapter.class.getSimpleName();

    private List<FullDressColtheResult.Data> mList;
    ...
    public FullDessGridAdapter(Context mContext) {
    ...
    public FullDressColtheResult.Data getItem(int position) {
        return mList.get(position);
    }

    public void addAll(List<FullDressColtheResult.Data> list) {
    ...
    public void reSetData(List<FullDressColtheResult.Data> list) {
        this.mList = list;
        notifyDataSetChanged();
    }
...
//    }
    ...
    class FullDessGridViewHodler extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(FullDressColtheResult.Data data) {
...
//                    .centerCrop()
                    ...
                    .priority(Priority.HIGH);
//                    .transform(new GlideCircleTransform(mContext, 2, mContext.getResources().getColor(R.color.black)));
            String imageUrl = "https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2913582182,143676263&fm=27&gp=0.jpg";
