...
public class TimeCreditActivity extends AppCompatActivity {
    private static final String TAG = TimeCreditActivity.class.getSimpleName();
...
//                    recyclerViewSelectStore.setNestedScrollingEnabled(false);
                    ...
                    ToastUtil.showShort(TimeCreditActivity.this, mRes.getMsg());
                }
            } else {
