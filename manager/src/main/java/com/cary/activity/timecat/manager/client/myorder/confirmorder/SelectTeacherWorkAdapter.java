...
public class SelectTeacherWorkAdapter extends RecyclerView.Adapter<SelectTeacherWorkAdapter.ViewHolder> implements View.OnClickListener {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.iv_select_teacher_works)
        ImageView ivSelectTeacherWorks;
        public ViewHolder(View itemView) {
            super(itemView);
//            ivSelectTeacherItemHead = (ImageView) itemView.findViewById(R.id.imgeview_item_show_image);
        }
    }
     ...
     * @param mContext
     */
    public SelectTeacherWorkAdapter(Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_select_teacher_item_works, parent, false);
...
//        Glide.with(mContext).load(imageUrl).apply(options2).into(holder.ivSelectTeacherWorks);
