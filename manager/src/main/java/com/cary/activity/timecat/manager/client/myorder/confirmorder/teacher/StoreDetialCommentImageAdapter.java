...
import com.cary.activity.timecat.manager.client.myorder.confirmorder.imageInfo.ImageInfoObj;
import com.cary.activity.timecat.manager.client.myorder.confirmorder.imageInfo.ImageWidgetInfoObj;
import com.cary.activity.timecat.manager.client.myorder.confirmorder.imageInfo.ShowPictureActivity;
...
//                    .transform(new GlideCircleTransform(mContext, 2, mContext.getResources().getColor(R.color.black)));
        String imageUrl ="https://ss1.baidu.com/-4o3dSag_xI4khGko9WTAnF6hhy/image/h%3D300/sign=1cde79857e0e0cf3bff748fb3a47f23d/adaf2edda3cc7cd9019ce04e3501213fb90e91f0.jpg";
//                HttpUrlClient.ALIYUNPHOTOBASEURL + mList[position];
