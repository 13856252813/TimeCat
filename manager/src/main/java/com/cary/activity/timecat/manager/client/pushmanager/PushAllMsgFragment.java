...
public class PushAllMsgFragment extends Fragment {
    private static String TAG = PushAllMsgFragment.class.getSimpleName();
    Unbinder unbinder;
    ...
    @SuppressLint("ValidFragment")
    public PushAllMsgFragment(int type) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        etPushMobile.setVisibility(View.GONE);
        ...
        btnPushmessageConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)) {
                    ...
                    createSinglePushAll(title, content);
                }
            }
        });
        return view;
    ...
    private void createSinglePushAll(String title, String content) {
        Call<ModelBeanData> call = mApi.getService().createCommitPushAllMsg(token, uid, storeId, title, content);
