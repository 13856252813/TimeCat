...
public class IntegralAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<IntegralResult.Data> mDateBeen;
    ...
    public RecyclerView.ViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.activity_credit_list_item, parent, false);
    ...
    public IntegralResult.Data getItem(int position) {
        return mDateBeen.get(position);
    }

    public void addAll(List<IntegralResult.Data> list) {
    ...
    public void reSetData(List<IntegralResult.Data> list) {
        this.mDateBeen = list;
        notifyDataSetChanged();
    }
...
//        ViewHolder holder = new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.activity_credit_list_item, parent, false));
//        return holder;
//    }
//
...
//    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(IntegralResult.Data data) {
            tv_integral_list_item_name.setText(data.getTitle());
