...
public class PushAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<PushResult.Data> mList;
    ...
    public PushResult.Data getItem(int position) {
        return mList.get(position);
    }

    public void addAll(List<PushResult.Data> list) {
    ...
    public void reSetData(List<PushResult.Data> list) {
        this.mList = list;
        notifyDataSetChanged();
    }
...
//添加点击加载更多监听
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(PushResult.Data data) {
            textViewtitle.setText(data.getTitle());
            textViewdesc.setText(data.getContent());
            textViewtime.setText(data.getPushTime());
