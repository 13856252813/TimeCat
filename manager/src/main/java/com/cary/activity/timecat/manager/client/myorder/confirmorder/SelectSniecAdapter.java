...
public class SelectSniecAdapter extends RecyclerView.Adapter<SelectSniecAdapter.ViewHolder> implements View.OnClickListener {
//    private List<ShowImageCommitResult.Data> mLists = new ArrayList<>();
     ...
     * @param mContext
     */
    public SelectSniecAdapter(Context mContext) {
...
//        this.mLists = mLists;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_show_image_item, parent, false);
...
//        ShowImageCommitResult.Data data = mLists.get(position);
        holder.showName.setText("name");//data.getTitle());
