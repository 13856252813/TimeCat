...
public class RecyclerGridViewAdapter extends RecyclerView.Adapter<RecyclerGridViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = inf.inflate(R.layout.fragment_recycler_item, viewGroup, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.fragment_recycler_item_textview);
            imageView = (ImageView) itemView.findViewById(R.id.fragment_recycler_item_iamgeview);
        }
    }
    //单机事件
