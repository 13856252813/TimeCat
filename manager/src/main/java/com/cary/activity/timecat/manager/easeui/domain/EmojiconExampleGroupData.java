package com.cary.activity.timecat.manager.easeui.domain;
...
public class EmojiconExampleGroupData {
    ...
    private static EaseEmojiconGroupEntity createData(){
        ...
        for(int i = 0; i < icons.length; i++){
            ...
            datas[i].setName(MyRealApplication.getInstance().getApplicationContext().getString(R.string.emojicon_test_name)+ (i+1));
