package com.cary.activity.timecat.manager.easeui.conference;
...
import com.cary.activity.timecat.manager.easeui.widget.EaseViewGroup;
 ...
 * 多人音视频会议界面
 */
public class ConferenceActivity extends EaseBaseActivity implements EMConferenceListener {
