...
public class HotScenicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hot_scenic);
...
//                Intent intent = new Intent(HotScenicActivity.this, StoreDetialActivity.class);
