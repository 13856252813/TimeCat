...
import com.cary.activity.timecat.manager.client.myorder.confirmorder.SelectTeacherWorkAdapter;

import java.util.List;

public class TeacherApplyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<TeacherApplyResult.Data> mDateBeen;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(final TeacherApplyResult.Data data) {
...
// HttpUrlClient.ALIYUNPHOTOBASEURL + data.getWebUser().getImgurl();
     ...
     * @param mContext
     */
    public TeacherApplyAdapter(Context mContext) {
    ...
    public TeacherApplyResult.Data getItem(int position) {
        return mDateBeen.get(position);
    }

    public void addAll(List<TeacherApplyResult.Data> list) {
    ...
    public void reSetData(List<TeacherApplyResult.Data> list) {
        this.mDateBeen = list;
