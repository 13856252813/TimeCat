...
public class EmployeeManagerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<EmployeeManagerResult.Data> mDateBeen;
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(final EmployeeManagerResult.Data data) {
//        holder.showPrice.setText("¥" + data.getPrice());
            tvTeacherNameNick.setText(data.getNickname());
...
// HttpUrlClient.ALIYUNPHOTOBASEURL + data.getWebUser().getImgurl();
     ...
     * @param mContext
     */
    public EmployeeManagerAdapter(Context mContext) {
    ...
    public EmployeeManagerResult.Data getItem(int position) {
        return mDateBeen.get(position);
    }

    public void addAll(List<EmployeeManagerResult.Data> list) {
    ...
    public void reSetData(List<EmployeeManagerResult.Data> list) {
        this.mDateBeen = list;
