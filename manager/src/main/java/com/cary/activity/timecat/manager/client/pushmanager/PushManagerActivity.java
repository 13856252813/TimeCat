...
public class PushManagerActivity extends AppCompatActivity {
    ...
    private static final String TAG = PushManagerActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //调用切换Fragmnet方法
        changeFragmnet(new PushAllFragment(1));
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_push_all:
                ...
                break;
            case R.id.ll_single:
                changeFragmnet(new PushAllFragment(2));
