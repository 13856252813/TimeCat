...
public class MyFriendListActivity extends AppCompatActivity {
    ...
    private String TAG = MyFriendListActivity.class.getSimpleName();
    ...
    SwipeRefreshLayout swiperefreshlayoutMyfriend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerMyfriendList.setAdapter(mAdapter);
        ...
        recyclerMyfriendList.setItemAnimator(new DefaultItemAnimator());
...
//        });
        ...
        swiperefreshlayoutMyfriend.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        recyclerMyfriendList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override//滚动状态变化时回调
    ...
    public void loadMore() {
        mAdapter.setLoadStatus(MyFriendAdapter.LoadStatus.LOADING_MORE);
        mAdapter.refresh();
        currentpage++;
        createSingleFriend();
    }
            ...
            if (response.isSuccessful()) {
                ...
                if ("00".equals(mFriendRes.getCode())) {
                    ...
                    if (currentpage == 1) {
                        ...
                        swiperefreshlayoutMyfriend.setRefreshing(false);
                    ...
                    if (SumPage < 2) {
                        mAdapter.setLoadStatus(MyFriendAdapter.LoadStatus.LOADING_GONE);
                    } else {
                        mAdapter.setLoadStatus(MyFriendAdapter.LoadStatus.CLICK_LOAD_MORE);
                    }
                } else {
                    ToastUtil.showShort(MyFriendListActivity.this, mFriendRes.getMsg());
                }
            } else {
    ...
    private void createSingleFriend() {
        Call<FriendListResult> call = mFriendApi.getService().createCommitPage(token, uid, currentpage);
