...
import com.cary.activity.timecat.fragment.index.selectstore.detial.StoreDetialCommentImageAdapter;
 ...
 * 最新时光留言
 */
public class TeacherDetialCommentAdapter extends RecyclerView.Adapter<TeacherDetialCommentAdapter.ViewHolder> implements View.OnClickListener {

    private List<TeacherCommentResult.Data> mLists = new ArrayList<>();
     ...
     * @param mContext
     */
    public TeacherDetialCommentAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public void setDatas(List<TeacherCommentResult.Data> mLists) {
        this.mLists = mLists;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TeacherCommentResult.Data data = mLists.get(position);
        holder.tvTeacherDetialLeaveMessageUserName.setText("时光用户");//data.getTitle());
        holder.tvTeacherDetialLeaveMessageUserTime.setText(data.getCreateTime());
...
//                    .transform(new GlideCircleTransform(mContext, 2, mContext.getResources().getColor(R.color.black)));
        String imageUrl ="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1099171353,3577182778&fm=27&gp=0.jpg";
