...
public class TimeShopSelectionPopuWindow implements View.OnClickListener, View.OnTouchListener, OnSelectedListener {

    private static final String TAG = TimeShopSelectionPopuWindow.class.getSimpleName();
    ...
    private TimeShopShoppingSelectView view;
    //    String jsonString;
//    GoodsBean mData;
    private TimeShopDetialResult mData;
    ...
    public TimeShopSelectionPopuWindow(Activity context, OnClickConfrmListener clickListener, TimeShopDetialResult mData) {
        this.mData = mData;
        LayoutInflater inflater = LayoutInflater.from(context);
        mContext = context;
        this.clickListener = clickListener;
        mMenuView = inflater.inflate(R.layout.activity_time_shop_selection_layout, null);
        view = (TimeShopShoppingSelectView) mMenuView.findViewById(R.id.v);
        //设置监听需要在设置数据源之前
...
//        getData();
        ...
        tvSelectionPrice.setText("¥" + mData.getData().getAmount());
...
//                    }
                ...
                if (tempLength == mData.getData().getNorms().size()) {
