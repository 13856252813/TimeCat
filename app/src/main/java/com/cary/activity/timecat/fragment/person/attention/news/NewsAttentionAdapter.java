...
public class NewsAttentionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<NewsAttentionResult.Data> mList;
    ...
    public NewsAttentionAdapter(Context mContext) {
    ...
    public NewsAttentionResult.Data getItem(int position) {
        return mList.get(position);
    }

    public void addAll(List<NewsAttentionResult.Data> list) {
    ...
    public void reSetData(List<NewsAttentionResult.Data> list) {
        this.mList = list;
        notifyDataSetChanged();
    }
...
//添加点击加载更多监听
    ...
    class NewsViewHodler extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(NewsAttentionResult.Data data) {
            fragment_news_list_item_title.setText(data.getInformation().getTitle());
            fragment_news_list_item_createtime.setText(data.getInformation().getCreateTime());
            String imageurl = "https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2907065096,2145851531&fm=27&gp=0.jpg";
            Glide.with(mContext).load(imageurl).into(fragment_news_list_item_img);
