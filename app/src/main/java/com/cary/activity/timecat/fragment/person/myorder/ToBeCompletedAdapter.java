    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(TaskListResult.Data data) {
            ...
            if ("gp".equals(type)) {
                ...
                iv_myorder_iamge.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.photocamera));
            } else if ("sx".equals(type)) {
                tv_myorder_name.setText("摄影");
                iv_myorder_iamge.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.videocamera));
            } else if ("gz".equals(type)) {
                tv_myorder_name.setText("化妆");
                iv_myorder_iamge.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.dressercamera));
            } else if ("wedding".equals(type)) {
                tv_myorder_name.setText("婚纱摄影");
                iv_myorder_iamge.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.mainicon1));
            } else if ("photo".equals(type)) {
                tv_myorder_name.setText("写真摄影");
                iv_myorder_iamge.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.mainicon2));
            } else if ("baby".equals(type)) {
                tv_myorder_name.setText("宝宝摄影");
                iv_myorder_iamge.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.mainicon3));
            }
