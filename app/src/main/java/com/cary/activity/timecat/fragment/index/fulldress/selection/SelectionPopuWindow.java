...
public class SelectionPopuWindow implements View.OnClickListener, View.OnTouchListener, OnSelectedListener {

    private static final String TAG = SelectionPopuWindow.class.getSimpleName();
    ...
    //    String jsonString;
//    GoodsBean mData;
    private FullDressDetialResult mData;
    ...
    public SelectionPopuWindow(Activity context, OnClickConfrmListener clickListener, FullDressDetialResult mData) {
        this.mData = mData;
        LayoutInflater inflater = LayoutInflater.from(context);
        mContext = context;
        this.clickListener = clickListener;
        mMenuView = inflater.inflate(R.layout.activity_full_dress_selection_layout, null);
        view = (ShoppingSelectView) mMenuView.findViewById(R.id.v);
        //设置监听需要在设置数据源之前
