...
public class ShowTeacherAdapter extends RecyclerView.Adapter<ShowTeacherAdapter.ViewHolder> implements View.OnClickListener {
    private List<StoreTeacherResult.DataBean> mLists = new ArrayList<>();
    ...
    public void setDatas(List<StoreTeacherResult.DataBean> mLists) {
        this.mLists = mLists;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        StoreTeacherResult.DataBean data = mLists.get(position);
        holder.showName.setText(data.getWebUser().getNickname());//data.getName());
        holder.teacherType.setText(data.getTeacherType());
        holder.teacherCriedit.setText(data.getWebUser().getCredit() + "");
...
//                    .centerCrop()
        ...
        String imageUrl = HttpUrlClient.ALIYUNPHOTOBASEURL + data.getWebUser().getImgurl();
